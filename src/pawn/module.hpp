...
struct BasePawnState : PawnFSM::State {
    ...
    void enter(Control& control) {
        ...
        fsmLogger->trace("Pawn {} entering state {}", std::string(e.path()), TypeName<TemplateState>());
    ...
    void exit(Control& control) {
        flecs::entity e = flecs::entity(control.context().ecs, control.context().id);
        fsmLogger->trace("Pawn {} exiting state {}", std::string(e.path()), TypeName<TemplateState>());
